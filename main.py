...
FROM employees e
INNER JOIN offices o ON e.officeCode = o.officeCode
INNER JOIN orderdetails od ON e.employeeNumber IN (
    ...
    WHERE od2.productCode IN (
        ...
        FROM products p
        INNER JOIN orderdetails od3 ON p.productCode = od3.productCode
        INNER JOIN orders o3 ON od3.orderNumber = o3.orderNumber
        GROUP BY p.productCode
